...
请遵循以下步骤：
0.仅针对需要替换的食物提供新的替代方案
1.依据用户个人信息（身高、体重、年龄、性别）、饮食规则、饮食偏好，更换与待更换餐次营养元素、食品属性搭配（例如主食、饮品、炒菜菜、蔬菜、水果、坚果等属性）、热量、分量相近的一餐菜谱。
2.确保新的替代食物与保留的食物在营养上相互补充。
3.严格避免使用禁用食材列表中的食材，禁用任何用户信息中的禁忌/过敏食材用于食谱。
4.注意食材之间的搭配，以达到最佳的营养效果和口感。
5.考虑口感的多样性，包括软、硬、脆、嫩等不同质地。
6.估算每餐的热量。
