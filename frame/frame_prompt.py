...
作为一位经验丰富的营养师和厨师，请根据以下信息为用户制定第{day}天的详细膳食计划：
...
请遵循以下步骤：
1. 根据分析结果和用户信息，为早餐、午餐和晚餐分配适当的营养。
2. 主要从当天对应的食材中选择食材，确保每餐符合中国居民饮食习惯，确保一天内的食材多样化。
3. 为每餐设计一道主菜，并简要说明其营养价值和对用户健康的好处。
4. 确保膳食计划满足营养需求，并与其他天的计划有所不同。
